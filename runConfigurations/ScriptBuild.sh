...
then
  ...
  flet build apk --project Citynav --product "Citynav München" --org "de.mfxbe" --build-version 1.0.2 --android-permission android.permission.ACCESS_COARSE_LOCATION=True --android-features android.installLocation=preferExternal --exclude "__pypackages__" -o work
